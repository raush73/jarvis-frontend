          ...
          <div className="detail-grid">
            ...
            {order.primaryCustomerContact && (
              <section className="detail-section">
                <h2>Primary Customer Contact</h2>
                <div className="contact-card">
                  <span className="contact-name">
                    {order.primaryCustomerContact.firstName} {order.primaryCustomerContact.lastName}
                  </span>
                  {order.primaryCustomerContact.email && (
                    <div className="contact-row">
                      <span className="contact-label">Email:</span>
                      <span className="contact-value">{order.primaryCustomerContact.email}</span>
                    </div>
                  )}
                  {order.primaryCustomerContact.officePhone && (
                    <div className="contact-row">
                      <span className="contact-label">Office:</span>
                      <span className="contact-value">{order.primaryCustomerContact.officePhone}</span>
                    </div>
                  )}
                  {order.primaryCustomerContact.cellPhone && (
                    <div className="contact-row">
                      <span className="contact-label">Cell:</span>
                      <span className="contact-value">{order.primaryCustomerContact.cellPhone}</span>
                    </div>
                  )}
                </div>
              </section>
