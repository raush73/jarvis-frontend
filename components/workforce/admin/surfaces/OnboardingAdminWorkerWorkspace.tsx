...
import { OnboardingAdminDocumentsPanel } from "../panels/OnboardingDocumentsPanel";
import { OnboardingExecutionEvidencePanel } from "../panels/OnboardingExecutionEvidencePanel";
    ...
    >
      ...
      {data ? (
        <>
          ...
          <OnboardingAdminDocumentsPanel candidateId={data.worker.candidateId} />

          <OnboardingExecutionEvidencePanel candidateId={data.worker.candidateId} />
