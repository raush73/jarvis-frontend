/**
 * Module 4.4 - the worker registration barrel.
 *
 ...
 * this capsule for a registration to point at. Administrative payroll-card fulfilment is separate,
 * later, governed work.
 */

import { createElement } from "react";
import { registerOnboardingModuleRenderer } from "@/components/workforce/onboarding/runtime/moduleRegistry";
import { PAYROLL_PAYMENT_MODULE_KEY } from "@/lib/workforce/payrollPaymentApi";
import PayrollPaymentModule from "./PayrollPaymentModule";

registerOnboardingModuleRenderer(PAYROLL_PAYMENT_MODULE_KEY, (props) =>
  createElement(PayrollPaymentModule, props),
);
